...
for curr_patient in range(1, num_of_patients+1):
    ...
    for file in range(1, num_of_files+1):
        ...
        update("INSERT INTO digital_medical_file(date_of_creation, patient_id) VALUES (%s, %s)", ins_date_of_creation, ins_patient_id)
    ...
    if num_of_files > 2:
        ...
        update("INSERT INTO numbers_of_prev_medical_files(file_id, prev_file_id) VALUES (%s, %s)", ins_file_id, ins_prev_file_id)
...
for curr_reg_number in range(1, num_of_reg_number):
    ...
    for diagnose in range(0, num_of_diagnoses):
        ...
        update("INSERT INTO diagnose(name, found_date, get_well_date, reg_number, patient_id, treatment) VALUES (%s, %s, %s, %s, %s, %s)", ins_name, ins_found_date, ins_get_well_date, ins_reg_number, ins_patient_id, ins_treatment)
...
for curr_reg_number in range(1, num_of_reg_number):
    ...
    for test in range(0, num_of_tests):
        ...
        update("INSERT INTO med_test(collection_date, results_available, results, reg_number, patient_id) VALUES (%s, %s, %s, %s, %s)", ins_collection_date, ins_results_available, ins_results, ins_reg_number, ins_patient_id)
...
for inventory in range(1, num_of_inventory+1):
    ...
    update("INSERT INTO inventory(name, price_to_sell, instruction) VALUES (%s, %s, %s)", ins_name, ins_price_to_sell, ins_instruction)
...
for inventory in range(1, num_of_inventory+1):
    ...
    for curr_sup in range(0, num_of_suppliers):
        ...
        update("INSERT INTO suppliers(item_id, supplier, price_to_buy) VALUES (%s, %s, %s)", ins_item_id, ins_supplier, ins_price_to_buy)
...
for doctor in range(1, num_of_doctors+1):
    ...
    update("INSERT INTO doctor(working_hours, specialization, name, license_id) VALUES (%s, %s, %s, %s)", ins_working_hours, ins_specialization, ins_name, ins_license_id)
...
for amb in range(1, num_of_amb+1):
    ...
    update("INSERT INTO ambulance(assigned, specialization, location) VALUES (%s, %s, %s)", ins_assigned, ins_specialization, ins_location)
...
for app in range(1, num_of_app+1):
    ...
    update("INSERT INTO appointment(patient_id, rec_id, doctor_id, date_and_time) VALUES (%s, %s, %s, %s)", ins_patient_id, ins_rec_id, ins_doctor_id, ins_date_and_time)
...
for chat in range(1, num_of_staff_chat+1):
    ...
    for id in staff_ids:
        update("INSERT INTO staff_chat(chat_id, staff_id) VALUES (%s, %s)", ins_chat_id, id[0])
...
busy_ambs = execute("SELECT amd_id FROM ambulance WHERE assigned=false")
...
for rec_amb in range(1, num_of_rec_amb+1):
    ...
    update("INSERT INTO receptionist_ambulance(ambulance_id, receptionist_id) VALUES (%s, %s)", ins_ambulance_id, ins_receptionist_id)
...
for rec_pat in range(1, num_of_rec_pat):
    ...
    update("INSERT INTO receptionist_patient(patient_id, receptionist_id) VALUES (%s, %s)", ins_patient_id, ins_receptionist_id)
